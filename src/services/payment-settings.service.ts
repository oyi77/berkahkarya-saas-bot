...
export class PaymentSettingsService {
  ...
  static async initializePricingDefaults(): Promise<void> {
    ...
    const defaults: Array<{ category: string; key: string; value: any }> = [
      ...
      // Subscriptions
      { category: 'subscription', key: 'lite', value: { name: 'Lite', monthlyIdr: 99000, yearlyIdr: 990000, monthlyCredits: 20, dailyLimit: 3 } },
      { category: 'subscription', key: 'pro', value: { name: 'Pro', monthlyIdr: 199000, yearlyIdr: 1990000, monthlyCredits: 50, dailyLimit: 10 } },
      { category: 'subscription', key: 'agency', value: { name: 'Agency', monthlyIdr: 499000, yearlyIdr: 4990000, monthlyCredits: 150, dailyLimit: 30 } },
    ];
