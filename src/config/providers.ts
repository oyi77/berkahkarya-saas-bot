...
export const PROVIDER_CONFIG: {
  ...
  video: {
    ...
    piapi: {
      ...
      quirks:
        "EXPENSIVE: Kling 1.6 via piapi.ai. Cost 5-15x higher than BytePlus/SiliconFlow. Only use when all others fail.",
    ...
    lingyaai: {
      ...
      failureThreshold: 3,
      recoveryTimeout: 90000,
      strengths: ["openai_compatible", "multi_model"],
      quirks: "OpenAI-compatible proxy with multiple video models",
      avoid: [],
      tokenLimit: 500,
      supportsImg2Video: true,
      maxDuration: 10,
    ...
    getgoapi: {
      ...
      failureThreshold: 3,
      recoveryTimeout: 90000,
      strengths: ["multi_model", "api_aggregator"],
      quirks: "API aggregator with multiple video model backends",
      avoid: [],
      tokenLimit: 500,
      supportsImg2Video: true,
      maxDuration: 10,
    ...
    apiyi: {
      ...
      failureThreshold: 3,
      recoveryTimeout: 120000,
      strengths: ["sora", "quality", "openai_compatible"],
      quirks: "OpenAI-compatible proxy with Sora 2 access",
      avoid: [],
      tokenLimit: 600,
      supportsImg2Video: true,
      maxDuration: 10,
    ...
    runware: {
      ...
      failureThreshold: 3,
      recoveryTimeout: 90000,
      strengths: ["video_generation", "fast"],
      quirks: "Dedicated video generation API",
      avoid: [],
      tokenLimit: 500,
      supportsImg2Video: true,
      maxDuration: 10,
    ...
    wavespeed: {
      ...
      failureThreshold: 3,
      recoveryTimeout: 90000,
      strengths: ["accelerated", "multi_model"],
      quirks: "Accelerated AI media generation with 1000+ models",
      avoid: [],
      tokenLimit: 500,
      supportsImg2Video: true,
      maxDuration: 10,
    ...
    zai_video: {
      ...
      failureThreshold: 3,
      recoveryTimeout: 90000,
      strengths: ["video_generation", "multi_model"],
      quirks: "Z.ai video generation API",
      avoid: [],
      tokenLimit: 500,
      supportsImg2Video: true,
      maxDuration: 10,
  ...
  image: {
    ...
    falai: {
      ...
      quirks:
        "artistic specialization, supports image-to-image and IP-Adapter for consistency",
      tokenLimit: 400,
      supportsImg2Img: true,
      supportsIPAdapter: true,
      costPerGenerationUsd: 0.03,
    ...
    laozhang: {
      ...
      quirks:
        "flux-kontext-pro for img2img (multipart), gpt-image-1 for text2img",
      tokenLimit: 500,
      supportsImg2Img: true,
      supportsIPAdapter: false,
    ...
    gemini: {
      ...
      quirks:
        "can accept reference image as multimodal input for guided generation",
      tokenLimit: 1000,
      supportsImg2Img: true,
      supportsIPAdapter: false,
    ...
    runware: {
      ...
      failureThreshold: 2,
      recoveryTimeout: 30000,
      strengths: ["fast", "multiple_models"],
      quirks: "Runware API for text-to-image and image-to-image",
      tokenLimit: 500,
      supportsImg2Img: true,
      supportsIPAdapter: false,
      costPerGenerationUsd: 0.02,
    ...
    wavespeed: {
      ...
      recoveryTimeout: 30000,
      strengths: ["accelerated", "multi_model"],
      quirks: "WaveSpeed accelerated image generation",
      tokenLimit: 500,
      supportsImg2Img: true,
      supportsIPAdapter: false,
      costPerGenerationUsd: 0.02,
    ...
    zai: {
      ...
      failureThreshold: 2,
      recoveryTimeout: 30000,
      strengths: ["multi_model", "quality"],
      quirks: "Z.ai image generation API",
      tokenLimit: 500,
      supportsImg2Img: true,
      supportsIPAdapter: false,
      costPerGenerationUsd: 0.02,
