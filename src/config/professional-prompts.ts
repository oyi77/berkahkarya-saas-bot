...
export const PROFESSIONAL_PROMPT_LIBRARY: Record<string, ProfessionalPrompt[]> = {
  fnb: [
    ...
    },
    {
      ...
      niche: 'fnb',
      prompt: 'Luxurious seafood tower on crushed ice, featuring whole poached lobster with bright red shell, freshly shucked oysters with lemon wedges, jumbo shrimp cocktail, king crab legs split open, mignonette sauce in silver ramekins, served on three-tier silver stand, coastal restaurant aesthetic, bright natural light simulating outdoor dining, luxury dining experience',
